...
dag = DAG('dados_api_aldo', default_args=default_args, schedule_interval=None)

task_test_connection = PythonOperator(
    task_id='test_mysql_connection',
    python_callable=mysql_connect,
    dag=dag,
)
...
task_test_connection >> task_extract_data >> task_process_data >> task_insert_data
